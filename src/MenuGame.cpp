...
int MenuGame::ShowMenuRescueComplete(SDL_Renderer* screen , TTF_Font* font){
    BaseObject::loadImage("assets//winner.jpg" , screen);
    ...
    TextObject text_menu[numberItem];
    text_menu[0].setText("Rescue Again!!");
    text_menu[0].setColor(TextObject::WHITE_TEXT);
    text_menu[0].LoadFromRenderText(font , screen);
        ...
        while(SDL_PollEvent(&events_)){
            switch(events_.type){
                ...
                case SDL_MOUSEMOTION:{
                    ...
                    if (xm >= 520 && xm <= 710 && ym >= 300 && ym <= 350){
                        //BaseObject::Free();
                        text_menu[0].setColor(176,224,230);
                        text_menu[0].LoadFromRenderText(font , screen);
                    }
                    else if (xm >= 560 && xm <= 670 && ym >= 450 && ym <= 500){
                        //BaseObject::Free();
                ...
                case SDL_MOUSEBUTTONDOWN:{
                    xm = events_.button.x;
                    ym = events_.button.y;
                    if (xm >= 520 && xm <= 720 && ym >= 300 && ym <= 350){
                        BaseObject::Free();
                        text_menu[0].Free();
                        text_menu[1].Free();
                        IMG_Quit();
